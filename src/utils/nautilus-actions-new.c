...
static const ArgFromDataDef st_arg_from_data_def[] = {
		...
		{ action_data_groups,  FMA_FACTORY_OBJECT_ITEM_GROUP,       FMAFO_DATA_TOOLTIP,            &tooltip },
		{ action_data_groups,  FMA_FACTORY_OBJECT_ITEM_GROUP,       FMAFO_DATA_ICON,               &icon },
		{ action_data_groups,  FMA_FACTORY_OBJECT_ITEM_GROUP,       FMAFO_DATA_ENABLED,            &enabled },
		{ action_data_groups,  FMA_FACTORY_OBJECT_ACTION_GROUP,     FMAFO_DATA_TARGET_SELECTION,   &target_selection },
		{ action_data_groups,  FMA_FACTORY_OBJECT_ACTION_GROUP,     FMAFO_DATA_TARGET_LOCATION,    &target_location },
		{ action_data_groups,  FMA_FACTORY_OBJECT_ACTION_GROUP,     FMAFO_DATA_TARGET_TOOLBAR,     &target_toolbar },
		{ action_data_groups,  FMA_FACTORY_OBJECT_ACTION_GROUP,     FMAFO_DATA_TOOLBAR_LABEL,      &label_toolbar },
		{ profile_data_groups, FMA_FACTORY_OBJECT_PROFILE_GROUP,    FMAFO_DATA_PATH,               &command },
		{ profile_data_groups, FMA_FACTORY_OBJECT_PROFILE_GROUP,    FMAFO_DATA_PARAMETERS,         &parameters },
		{ profile_data_groups, FMA_FACTORY_OBJECT_PROFILE_GROUP,    FMAFO_DATA_WORKING_DIR,        &workingdir },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_BASENAMES,          &basenames_array },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_MATCHCASE,          &matchcase },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_MIMETYPES,          &mimetypes_array },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_ISFILE,             &isfile },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_ISDIR,              &isdir },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_MULTIPLE,           &accept_multiple },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_SCHEMES,            &schemes_array },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_FOLDERS,            &folders_array },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_SELECTION_COUNT,    &selection_count },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_ONLY_SHOW,          &onlyshow_array },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_NOT_SHOW,           &notshow_array },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_TRY_EXEC,           &try_exec },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_SHOW_IF_REGISTERED, &show_registered },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_SHOW_IF_TRUE,       &show_true },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_SHOW_IF_RUNNING,    &show_running },
		{ profile_data_groups, FMA_FACTORY_OBJECT_CONDITIONS_GROUP, FMAFO_DATA_CAPABILITITES,      &capability_array },
		{ NULL }
};
