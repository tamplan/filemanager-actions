...
/**
 * SECTION: nact_tree_model_dnd
 * @short_description: #NactTreeModel function definitions for drag and drop.
 * @include: nact/nact-tree-model-dnd.h
 */

#ifndef __NACT_TREE_MODEL_DND_H__
#define __NACT_TREE_MODEL_DND_H__
...
#endif /* __NACT_TREE_MODEL_DND_H__ */
